...
class _MoviesWidgetState extends State<MoviesWidget> {
  ...
  Widget build(BuildContext context) {
    final String message = context.watch<MovieListCubit>().errorMessage;
    return Stack(
      children: <Widget>[
...
class _MoviesListBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final int length = cubit.state.movies.length;
...
class _MoviesListRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final MovieListRowData movie =
        context.read<MovieListCubit>().state.movies[index];
